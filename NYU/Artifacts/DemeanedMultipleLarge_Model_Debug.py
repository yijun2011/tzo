...
X_FILE   = DATA_DIR + 'DistortedImages_188_X_Full_Scaled_50.npz';
Y_FILE   = DATA_DIR + 'OriginalImages_188_X_Full_Scaled_50.npz';

mm = MM.model_manager('DemeanedMultipleLarge_Model_Debug', X_FILE, Y_FILE, normalized=False);
mm.set_logger();
mm.set_checkpoint();
