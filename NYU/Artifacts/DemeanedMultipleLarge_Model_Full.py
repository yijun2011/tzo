...
X_FILE   = DATA_DIR + 'DistortedImages_188_X_Full.npz';
Y_FILE   = DATA_DIR + 'OriginalImages_188_X_Full.npz';

mm = MM.model_manager('DemeanedMultipleLarge_Model_Full', X_FILE, Y_FILE, normalized=False);
mm.set_logger();
mm.set_checkpoint();
...
model.compile(loss=losses.mean_squared_error, optimizer=optimizers.nadam());
